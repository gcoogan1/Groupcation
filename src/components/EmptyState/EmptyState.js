 ...
 * @prop {function} onPress optional -> onPress event for button
 * @prop {string} label optional -> label of button
...
const EmptyState = ({ text, onPress, label, iconLeft }) => {
  return (
    <View
      style={[emptyStateStyles.container, !label && { borderStyle: "dashed" }]}
    >
